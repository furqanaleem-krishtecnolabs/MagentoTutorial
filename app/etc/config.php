...
return [
    'modules' => [
        ...
        'TrainingFurqan_Bike' => 1,
        'TrainingFurqan_PopUpLogin' => 1,
        'TrainingFurqan_ProductDailyDeal' => 1,
        'TrainingFurqan_Simpleshipping' => 1,
        'TrainingFurqan_StaticBlock' => 1,
        'TrainingFurqan_UpdateQtyAndStatus' => 1,
        'Vertex_Tax' => 1,
