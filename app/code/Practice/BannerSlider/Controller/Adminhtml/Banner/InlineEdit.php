...
class InlineEdit extends \Magento\Backend\App\Action
{
        ...
        if ($this->getRequest()->getParam('isAjax')) {
            ...
            if (!count($postItems)) {
                ...
                foreach (array_keys($postItems) as $bannerId) {
                    ...
                    $model = $this->_objectManager->create('Practice\BannerSlider\Model\Banner');
                    $model->load($bannerId);
                    try {
     ...
     * @return string
     */
    protected function getErrorWithBannerId(\Practice\BannerSlider\Model\Banner $banner, $errorText)
    {
    ...
    {
        return $this->_authorization->isAllowed('Practice_BannerSlider::banner_create') ||
            $this->_authorization->isAllowed('Practice_BannerSlider::banner_update');
    }
}